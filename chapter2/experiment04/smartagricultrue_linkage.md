...
1. 打开成功后主界面会默认显示自动恒温控制界面，

![](2017-05-17-10-26-56.png)

2. 勾选☑️上**联动控制**选项，此时执行器下的控制按钮会变为不可点击状态。

3. 点击**阀值设定**按钮，在弹窗中设置可触发当前温度的数值，点击确定后执行器会自动联动。

![](2017-05-17-10-28-07.png)

![](2017-05-17-10-28-44.png)


4. 点击菜单按钮，在弹出的抽屉导航菜单中选择**自动调风**，跳转到改界面，如图：

![](2017-05-17-10-15-40.png)

![](2017-05-17-10-16-56.png)

5. 点击菜单按钮，在弹出的抽屉导航菜单中选择**自动灌溉**，跳转到改界面，如图：

![](2017-05-17-10-24-09.png)

![](2017-05-17-10-30-14.png)